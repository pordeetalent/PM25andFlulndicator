# MQTT IoT Core
## การใช้งานโค้ด MQTT IoT Core สำหรับโครงการนี้

MQTT IoT Core เป็นบริการ IoT ของ MQTT โดยรูปแบบการให้บริการคือ MQTT จะมีบริการรับและส่งข้อมูล PubSub โดยที่เราจะทำให้บอร์ด NodeMCU ของเราส่งข้อมูลขึ้นไปยัง MQTT ของเรา
